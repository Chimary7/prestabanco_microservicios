...
public class CreditService {
    ...
    public ArrayList<credit> getCreditByRut(String rutClient){
        ...
        Users user = restTemplate.getForObject("http://userService/user/" + rutClient, Users.class);
    ...
    public credit saveCredit(credit credit){
        ...
        LoanType loanType = restTemplate.getForObject("http://LoantypeService/api/loanType/loan?id=" + credit.getIdLoanType(), LoanType.class);
        ...
        Users user = restTemplate.getForObject("http://userService/user/" + credit.getRutClient(), Users.class);
